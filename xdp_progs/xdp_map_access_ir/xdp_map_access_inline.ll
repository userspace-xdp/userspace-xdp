; ModuleID = 'xdp_map_access_ir/xdp_map_access.ll'
...
setupBlock:
  ...
  %8 = add i64 %2, -4
  %arrayidx = getelementptr inbounds [512 x i64], ptr @ctl_array, i64 0
...
bb_inst_15:                                       ; preds = %bb_inst_13
  %13 = add i64 %2, -8
  %arrayidx1 = getelementptr inbounds [2 x i32], ptr @ctl_array, i64 0
