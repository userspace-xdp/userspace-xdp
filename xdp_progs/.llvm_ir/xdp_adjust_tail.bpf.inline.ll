...
bb_inst_60:                                       ; preds = %bb_inst_42
  ...
  %51 = call i64 @bpf_helper_ext_0028(i64 0, i64 0, i64 %36, i64 92, i64 0)
  %52 = lshr i64 %51, 16
  %53 = add i64 %52, %51
  ...
  %71 = call i64 @bpf_helper_ext_0028(i64 0, i64 0, i64 %56, i64 20, i64 0)
  %72 = lshr i64 %71, 16
  %73 = add i64 %72, %71
  ...
  %arrayidx = getelementptr inbounds [1 x i64], ptr @__icmpcnt, i64 0
  %78 = ptrtoint ptr %arrayidx to i64
  %79 = icmp eq i64 %78, 0
