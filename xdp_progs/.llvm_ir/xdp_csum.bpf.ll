...
bb_inst_0:                                        ; preds = %setupBlock
  ...
  store i64 %7, ptr %r3, align 4
  store i64 23, ptr %r1, align 4
  %8 = load i64, ptr %r1, align 4
  %9 = trunc i64 %8 to i32
  %10 = load ptr, ptr %r10, align 8
  %11 = getelementptr i8, ptr %10, i64 -4
  store i32 %9, ptr %11, align 4
  store i64 2, ptr %r0, align 4
  %12 = load i64, ptr %r3, align 4
  store i64 %12, ptr %r6, align 4
  %13 = load i64, ptr %r6, align 4
  %14 = add i64 %13, 14
  store i64 %14, ptr %r6, align 4
  %15 = load i64, ptr %r2, align 4
  %16 = load i64, ptr %r6, align 4
  %17 = icmp ugt i64 %16, %15
  br i1 %17, label %bb_inst_64, label %bb_inst_8

bb_inst_8:                                        ; preds = %bb_inst_0
  ...
  %23 = icmp ne i64 %22, 8
  br i1 %23, label %bb_inst_64, label %bb_inst_10

bb_inst_10:                                       ; preds = %bb_inst_8
  %24 = load i64, ptr %r3, align 4
  store i64 %24, ptr %r1, align 4
  %25 = load i64, ptr %r1, align 4
  %26 = add i64 %25, 34
  store i64 %26, ptr %r1, align 4
  %27 = load i64, ptr %r2, align 4
  %28 = load i64, ptr %r1, align 4
  %29 = icmp ugt i64 %28, %27
  br i1 %29, label %bb_inst_64, label %bb_inst_13

bb_inst_13:                                       ; preds = %bb_inst_10
  %30 = load i64, ptr %r3, align 4
  %31 = load ptr, ptr %r10, align 8
  %32 = getelementptr i8, ptr %31, i64 -16
  store i64 %30, ptr %32, align 4
  store i64 0, ptr %r7, align 4
  store i64 32, ptr %r9, align 4
  store i64 4294901760, ptr %r8, align 4
  br label %bb_inst_18

bb_inst_18:                                       ; preds = %bb_inst_13, %bb_inst_35
  store i64 0, ptr %r1, align 4
  store i64 0, ptr %r2, align 4
  %33 = load i64, ptr %r6, align 4
  store i64 %33, ptr %r3, align 4
  store i64 20, ptr %r4, align 4
  %34 = load i64, ptr %r7, align 4
  store i64 %34, ptr %r5, align 4
  %35 = load i64, ptr %r1, align 4
  %36 = load i64, ptr %r2, align 4
  %37 = load i64, ptr %r3, align 4
  %38 = load i64, ptr %r4, align 4
  %39 = load i64, ptr %r5, align 4
  %40 = call i64 @_bpf_helper_ext_0028(i64 %35, i64 %36, i64 %37, i64 %38, i64 %39)
  store i64 %40, ptr %r0, align 4
  br label %bb_inst_24

bb_inst_24:                                       ; preds = %bb_inst_18
  %41 = load i64, ptr %r0, align 4
  store i64 %41, ptr %r7, align 4
  %42 = load i64, ptr %r7, align 4
  %43 = load i64, ptr %r8, align 4
  %44 = and i64 %42, %43
  store i64 %44, ptr %r7, align 4
  %45 = load i64, ptr %r7, align 4
  %46 = lshr i64 %45, 16
  store i64 %46, ptr %r7, align 4
  %47 = load i64, ptr %r7, align 4
  %48 = load i64, ptr %r0, align 4
  %49 = add i64 %47, %48
  store i64 %49, ptr %r7, align 4
  %50 = load i64, ptr %r7, align 4
  %51 = xor i64 %50, -1
  store i64 %51, ptr %r7, align 4
  %52 = load i64, ptr %r7, align 4
  %53 = trunc i64 %52 to i16
  %54 = load ptr, ptr %r6, align 8
  %55 = getelementptr i8, ptr %54, i64 10
  store i16 %53, ptr %55, align 2
  %56 = load i64, ptr %r10, align 4
  store i64 %56, ptr %r2, align 4
  ...
  %62 = load i64, ptr %r4, align 4
  %63 = load i64, ptr %r5, align 4
  %64 = call i64 @_bpf_helper_ext_0001(i64 %59, i64 %60, i64 %61, i64 %62, i64 %63)
  store i64 %64, ptr %r0, align 4
  br label %bb_inst_35

bb_inst_35:                                       ; preds = %bb_inst_24
  %65 = load i64, ptr %r7, align 4
  %66 = and i64 %65, 65535
  store i64 %66, ptr %r7, align 4
  %67 = load i64, ptr %r9, align 4
  %68 = add i64 %67, -1
  store i64 %68, ptr %r9, align 4
  %69 = load i64, ptr %r9, align 4
  ...
  %75 = icmp ne i64 %74, 0
  br i1 %75, label %bb_inst_18, label %bb_inst_41

bb_inst_41:                                       ; preds = %bb_inst_35
  %76 = load i64, ptr %r10, align 4
  store i64 %76, ptr %r2, align 4
  %77 = load i64, ptr %r2, align 4
  %78 = add i64 %77, -4
  store i64 %78, ptr %r2, align 4
  store i64 0, ptr %r1, align 4
  %79 = load i64, ptr %r1, align 4
  %80 = load i64, ptr %r2, align 4
  %81 = load i64, ptr %r3, align 4
  %82 = load i64, ptr %r4, align 4
  %83 = load i64, ptr %r5, align 4
  %84 = call i64 @_bpf_helper_ext_0001(i64 %79, i64 %80, i64 %81, i64 %82, i64 %83)
  store i64 %84, ptr %r0, align 4
  br label %bb_inst_46

bb_inst_46:                                       ; preds = %bb_inst_41
  %85 = load i64, ptr %r0, align 4
  %86 = icmp eq i64 %85, 0
  br i1 %86, label %bb_inst_50, label %bb_inst_47

bb_inst_47:                                       ; preds = %bb_inst_46
  ...
  %91 = add i64 %90, 1
  store i64 %91, ptr %r1, align 4
  %92 = load i64, ptr %r1, align 4
  %93 = load ptr, ptr %r0, align 8
  %94 = getelementptr i8, ptr %93, i64 0
  store i64 %92, ptr %94, align 4
  br label %bb_inst_50

bb_inst_50:                                       ; preds = %bb_inst_47, %bb_inst_46
  %95 = load ptr, ptr %r10, align 8
  %96 = getelementptr i8, ptr %95, i64 -16
  %97 = load i64, ptr %96, align 4
  store i64 %97, ptr %r4, align 4
  %98 = load ptr, ptr %r4, align 8
  %99 = getelementptr i8, ptr %98, i64 0
  %100 = load i16, ptr %99, align 2
  %101 = zext i16 %100 to i64
  store i64 %101, ptr %r1, align 4
  %102 = load ptr, ptr %r4, align 8
  %103 = getelementptr i8, ptr %102, i64 6
  %104 = load i16, ptr %103, align 2
  %105 = zext i16 %104 to i64
  store i64 %105, ptr %r2, align 4
  %106 = load i64, ptr %r2, align 4
  %107 = trunc i64 %106 to i16
  %108 = load ptr, ptr %r4, align 8
  %109 = getelementptr i8, ptr %108, i64 0
  store i16 %107, ptr %109, align 2
  %110 = load ptr, ptr %r4, align 8
  %111 = getelementptr i8, ptr %110, i64 8
  %112 = load i16, ptr %111, align 2
  %113 = zext i16 %112 to i64
  store i64 %113, ptr %r2, align 4
  %114 = load ptr, ptr %r4, align 8
  %115 = getelementptr i8, ptr %114, i64 2
  %116 = load i16, ptr %115, align 2
  %117 = zext i16 %116 to i64
  store i64 %117, ptr %r3, align 4
  %118 = load i64, ptr %r3, align 4
  %119 = trunc i64 %118 to i16
  %120 = load ptr, ptr %r4, align 8
  %121 = getelementptr i8, ptr %120, i64 8
  store i16 %119, ptr %121, align 2
  %122 = load i64, ptr %r2, align 4
  %123 = trunc i64 %122 to i16
  %124 = load ptr, ptr %r4, align 8
  %125 = getelementptr i8, ptr %124, i64 2
  store i16 %123, ptr %125, align 2
  %126 = load ptr, ptr %r4, align 8
  %127 = getelementptr i8, ptr %126, i64 10
  %128 = load i16, ptr %127, align 2
  %129 = zext i16 %128 to i64
  store i64 %129, ptr %r2, align 4
  %130 = load ptr, ptr %r4, align 8
  %131 = getelementptr i8, ptr %130, i64 4
  %132 = load i16, ptr %131, align 2
  %133 = zext i16 %132 to i64
  store i64 %133, ptr %r3, align 4
  %134 = load i64, ptr %r3, align 4
  %135 = trunc i64 %134 to i16
  %136 = load ptr, ptr %r4, align 8
  %137 = getelementptr i8, ptr %136, i64 10
  store i16 %135, ptr %137, align 2
  %138 = load i64, ptr %r1, align 4
  %139 = trunc i64 %138 to i16
  %140 = load ptr, ptr %r4, align 8
  %141 = getelementptr i8, ptr %140, i64 6
  store i16 %139, ptr %141, align 2
  %142 = load i64, ptr %r2, align 4
  %143 = trunc i64 %142 to i16
  %144 = load ptr, ptr %r4, align 8
  %145 = getelementptr i8, ptr %144, i64 4
  store i16 %143, ptr %145, align 2
  store i64 3, ptr %r0, align 4
  br label %bb_inst_64

bb_inst_64:                                       ; preds = %bb_inst_50, %bb_inst_10, %bb_inst_8, %bb_inst_0
  %146 = load i64, ptr %callItemCnt, align 4
  %147 = icmp eq i64 %146, 0
  br i1 %147, label %exitBlock, label %localFuncReturnBlock

exitBlock:                                        ; preds = %bb_inst_64
  %148 = load i64, ptr %r0, align 4
  ret i64 %148

localFuncReturnBlock:                             ; preds = %bb_inst_64
  %149 = load i64, ptr %callItemCnt, align 4
  %150 = sub i64 %149, 1
  %151 = getelementptr ptr, ptr %callStack, i64 %150
  %152 = load ptr, ptr %151, align 8
  %153 = sub i64 %149, 2
  %154 = getelementptr i64, ptr %callStack, i64 %153
  %155 = load i64, ptr %154, align 4
  store i64 %155, ptr %r6, align 4
  %156 = sub i64 %149, 3
  %157 = getelementptr i64, ptr %callStack, i64 %156
  %158 = load i64, ptr %157, align 4
  store i64 %158, ptr %r7, align 4
  %159 = sub i64 %149, 4
  %160 = getelementptr i64, ptr %callStack, i64 %159
  %161 = load i64, ptr %160, align 4
  store i64 %161, ptr %r8, align 4
  %162 = sub i64 %149, 5
  %163 = getelementptr i64, ptr %callStack, i64 %162
  %164 = load i64, ptr %163, align 4
  store i64 %164, ptr %r9, align 4
  %165 = sub i64 %149, 5
  store i64 %165, ptr %callItemCnt, align 4
  %166 = load i64, ptr %r10, align 4
  %167 = add i64 %166, 64
  store i64 %167, ptr %r10, align 4
  indirectbr ptr %152, []
}
