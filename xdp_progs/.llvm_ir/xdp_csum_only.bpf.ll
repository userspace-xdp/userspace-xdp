...
bb_inst_0:                                        ; preds = %setupBlock
  ...
  %9 = load i64, ptr %r6, align 4
  %10 = add i64 %9, 14
  store i64 %10, ptr %r6, align 4
  %11 = load i64, ptr %r2, align 4
  %12 = load i64, ptr %r6, align 4
  %13 = icmp ugt i64 %12, %11
  br i1 %13, label %bb_inst_45, label %bb_inst_6

bb_inst_6:                                        ; preds = %bb_inst_0
  %14 = load ptr, ptr %r7, align 8
  %15 = getelementptr i8, ptr %14, i64 12
  %16 = load i16, ptr %15, align 2
  %17 = zext i16 %16 to i64
  store i64 %17, ptr %r1, align 4
  %18 = load i64, ptr %r1, align 4
  %19 = icmp ne i64 %18, 8
  br i1 %19, label %bb_inst_45, label %bb_inst_8

bb_inst_8:                                        ; preds = %bb_inst_6
  %20 = load i64, ptr %r7, align 4
  store i64 %20, ptr %r1, align 4
  %21 = load i64, ptr %r1, align 4
  %22 = add i64 %21, 34
  store i64 %22, ptr %r1, align 4
  %23 = load i64, ptr %r2, align 4
  %24 = load i64, ptr %r1, align 4
  %25 = icmp ugt i64 %24, %23
  br i1 %25, label %bb_inst_45, label %bb_inst_11

bb_inst_11:                                       ; preds = %bb_inst_8
  store i64 0, ptr %r5, align 4
  store i64 32, ptr %r8, align 4
  store i64 4294901760, ptr %r9, align 4
  br label %bb_inst_15

bb_inst_15:                                       ; preds = %bb_inst_11, %bb_inst_20
  store i64 0, ptr %r1, align 4
  store i64 0, ptr %r2, align 4
  %26 = load i64, ptr %r6, align 4
  store i64 %26, ptr %r3, align 4
  store i64 20, ptr %r4, align 4
  %27 = load i64, ptr %r1, align 4
  %28 = load i64, ptr %r2, align 4
  %29 = load i64, ptr %r3, align 4
  %30 = load i64, ptr %r4, align 4
  %31 = load i64, ptr %r5, align 4
  %32 = call i64 @_bpf_helper_ext_0028(i64 %27, i64 %28, i64 %29, i64 %30, i64 %31)
  store i64 %32, ptr %r0, align 4
  br label %bb_inst_20

bb_inst_20:                                       ; preds = %bb_inst_15
  %33 = load i64, ptr %r0, align 4
  store i64 %33, ptr %r5, align 4
  %34 = load i64, ptr %r5, align 4
  %35 = load i64, ptr %r9, align 4
  %36 = and i64 %34, %35
  store i64 %36, ptr %r5, align 4
  %37 = load i64, ptr %r5, align 4
  %38 = lshr i64 %37, 16
  store i64 %38, ptr %r5, align 4
  %39 = load i64, ptr %r5, align 4
  %40 = load i64, ptr %r0, align 4
  %41 = add i64 %39, %40
  store i64 %41, ptr %r5, align 4
  %42 = load i64, ptr %r5, align 4
  %43 = xor i64 %42, -1
  store i64 %43, ptr %r5, align 4
  %44 = load i64, ptr %r5, align 4
  %45 = trunc i64 %44 to i16
  %46 = load ptr, ptr %r6, align 8
  %47 = getelementptr i8, ptr %46, i64 10
  store i16 %45, ptr %47, align 2
  %48 = load i64, ptr %r5, align 4
  %49 = and i64 %48, 65535
  store i64 %49, ptr %r5, align 4
  %50 = load i64, ptr %r8, align 4
  %51 = add i64 %50, -1
  store i64 %51, ptr %r8, align 4
  %52 = load i64, ptr %r8, align 4
  store i64 %52, ptr %r1, align 4
  %53 = load i64, ptr %r1, align 4
  %54 = shl i64 %53, 32
  store i64 %54, ptr %r1, align 4
  %55 = load i64, ptr %r1, align 4
  %56 = lshr i64 %55, 32
  store i64 %56, ptr %r1, align 4
  %57 = load i64, ptr %r1, align 4
  %58 = icmp ne i64 %57, 0
  br i1 %58, label %bb_inst_15, label %bb_inst_32

bb_inst_32:                                       ; preds = %bb_inst_20
  %59 = load ptr, ptr %r7, align 8
  %60 = getelementptr i8, ptr %59, i64 0
  %61 = load i16, ptr %60, align 2
  %62 = zext i16 %61 to i64
  store i64 %62, ptr %r1, align 4
  %63 = load ptr, ptr %r7, align 8
  %64 = getelementptr i8, ptr %63, i64 6
  %65 = load i16, ptr %64, align 2
  %66 = zext i16 %65 to i64
  store i64 %66, ptr %r2, align 4
  %67 = load i64, ptr %r2, align 4
  %68 = trunc i64 %67 to i16
  %69 = load ptr, ptr %r7, align 8
  %70 = getelementptr i8, ptr %69, i64 0
  store i16 %68, ptr %70, align 2
  %71 = load ptr, ptr %r7, align 8
  %72 = getelementptr i8, ptr %71, i64 8
  %73 = load i16, ptr %72, align 2
  %74 = zext i16 %73 to i64
  store i64 %74, ptr %r2, align 4
  %75 = load ptr, ptr %r7, align 8
  %76 = getelementptr i8, ptr %75, i64 2
  %77 = load i16, ptr %76, align 2
  %78 = zext i16 %77 to i64
  store i64 %78, ptr %r3, align 4
  %79 = load i64, ptr %r3, align 4
  %80 = trunc i64 %79 to i16
  %81 = load ptr, ptr %r7, align 8
  %82 = getelementptr i8, ptr %81, i64 8
  store i16 %80, ptr %82, align 2
  %83 = load i64, ptr %r2, align 4
  %84 = trunc i64 %83 to i16
  %85 = load ptr, ptr %r7, align 8
  %86 = getelementptr i8, ptr %85, i64 2
  store i16 %84, ptr %86, align 2
  %87 = load ptr, ptr %r7, align 8
  %88 = getelementptr i8, ptr %87, i64 10
  %89 = load i16, ptr %88, align 2
  %90 = zext i16 %89 to i64
  store i64 %90, ptr %r2, align 4
  %91 = load ptr, ptr %r7, align 8
  %92 = getelementptr i8, ptr %91, i64 4
  %93 = load i16, ptr %92, align 2
  %94 = zext i16 %93 to i64
  store i64 %94, ptr %r3, align 4
  %95 = load i64, ptr %r3, align 4
  %96 = trunc i64 %95 to i16
  %97 = load ptr, ptr %r7, align 8
  %98 = getelementptr i8, ptr %97, i64 10
  store i16 %96, ptr %98, align 2
  %99 = load i64, ptr %r1, align 4
  %100 = trunc i64 %99 to i16
  %101 = load ptr, ptr %r7, align 8
  %102 = getelementptr i8, ptr %101, i64 6
  store i16 %100, ptr %102, align 2
  %103 = load i64, ptr %r2, align 4
  %104 = trunc i64 %103 to i16
  %105 = load ptr, ptr %r7, align 8
  %106 = getelementptr i8, ptr %105, i64 4
  store i16 %104, ptr %106, align 2
  store i64 3, ptr %r0, align 4
  br label %bb_inst_45

bb_inst_45:                                       ; preds = %bb_inst_32, %bb_inst_8, %bb_inst_6, %bb_inst_0
  %107 = load i64, ptr %callItemCnt, align 4
  %108 = icmp eq i64 %107, 0
  br i1 %108, label %exitBlock, label %localFuncReturnBlock

exitBlock:                                        ; preds = %bb_inst_45
  %109 = load i64, ptr %r0, align 4
  ret i64 %109

localFuncReturnBlock:                             ; preds = %bb_inst_45
  %110 = load i64, ptr %callItemCnt, align 4
  %111 = sub i64 %110, 1
  %112 = getelementptr ptr, ptr %callStack, i64 %111
  %113 = load ptr, ptr %112, align 8
  %114 = sub i64 %110, 2
  %115 = getelementptr i64, ptr %callStack, i64 %114
  %116 = load i64, ptr %115, align 4
  store i64 %116, ptr %r6, align 4
  %117 = sub i64 %110, 3
  %118 = getelementptr i64, ptr %callStack, i64 %117
  %119 = load i64, ptr %118, align 4
  store i64 %119, ptr %r7, align 4
  %120 = sub i64 %110, 4
  %121 = getelementptr i64, ptr %callStack, i64 %120
  %122 = load i64, ptr %121, align 4
  store i64 %122, ptr %r8, align 4
  %123 = sub i64 %110, 5
  %124 = getelementptr i64, ptr %callStack, i64 %123
  %125 = load i64, ptr %124, align 4
  store i64 %125, ptr %r9, align 4
  %126 = sub i64 %110, 5
  store i64 %126, ptr %callItemCnt, align 4
  %127 = load i64, ptr %r10, align 4
  %128 = add i64 %127, 64
  store i64 %128, ptr %r10, align 4
  indirectbr ptr %113, []
}
