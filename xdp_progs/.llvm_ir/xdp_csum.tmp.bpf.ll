...
@rxcnt = dso_local global %struct.anon.1 zeroinitializer, section ".maps", align 8
...
@llvm.compiler.used = appending global [3 x i8*] [i8* bitcast (i32 (%struct.xdp_md*)* @xdp_pass to i8*), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_license, i32 0, i32 0), i8* bitcast (%struct.anon.1* @rxcnt to i8*)], section "llvm.metadata"
...
63:                                               ; preds = %60
  ...
  %90 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @bpf_map_lookup_elem, align 8
  %91 = bitcast i32* %16 to i8*
  %92 = call i8* %90(i8* noundef bitcast (%struct.anon.1* @rxcnt to i8*), i8* noundef %91)
...
97:                                               ; preds = %60
  %98 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @bpf_map_lookup_elem, align 8
  %99 = bitcast i32* %16 to i8*
  %100 = call i8* %98(i8* noundef bitcast (%struct.anon.1* @rxcnt to i8*), i8* noundef %99)
...
108:                                              ; preds = %104, %97
  ...
  call void @swap_src_dst_mac(i8* noundef %109)
  store i32 3, i32* %12, align 4
  %110 = load i32, i32* %12, align 4
  store i32 %110, i32* %6, align 4
  br label %111

111:                                              ; preds = %108, %57, %43, %34
