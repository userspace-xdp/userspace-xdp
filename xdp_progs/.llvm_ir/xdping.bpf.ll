...
bb_inst_0:                                        ; preds = %setupBlock
  ...
  %9 = load i64, ptr %r2, align 4
  %10 = add i64 %9, 98
  store i64 %10, ptr %r2, align 4
  %11 = load i64, ptr %r1, align 4
  %12 = load i64, ptr %r2, align 4
  %13 = icmp ugt i64 %12, %11
  br i1 %13, label %bb_inst_76, label %bb_inst_6
...
bb_inst_6:                                        ; preds = %bb_inst_0
  ...
  store i64 %17, ptr %r2, align 4
  %18 = load i64, ptr %r2, align 4
  %19 = icmp ne i64 %18, 8
  br i1 %19, label %bb_inst_76, label %bb_inst_8

bb_inst_8:                                        ; preds = %bb_inst_6
  %20 = load i64, ptr %r6, align 4
  ...
  store i64 %26, ptr %r2, align 4
  %27 = load i64, ptr %r2, align 4
  %28 = icmp ne i64 %27, 1
  br i1 %28, label %bb_inst_76, label %bb_inst_12

bb_inst_12:                                       ; preds = %bb_inst_8
  %29 = load i64, ptr %r6, align 4
  store i64 %29, ptr %r2, align 4
  %30 = load i64, ptr %r2, align 4
  %31 = add i64 %30, 34
  store i64 %31, ptr %r2, align 4
  store i64 0, ptr %r3, align 4
  %32 = load i64, ptr %r2, align 4
  %33 = load i64, ptr %r3, align 4
  %34 = add i64 %32, %33
  store i64 %34, ptr %r2, align 4
  %35 = load i64, ptr %r2, align 4
  %36 = load i64, ptr %r1, align 4
  %37 = icmp uge i64 %36, %35
  br i1 %37, label %bb_inst_35, label %bb_inst_17
...
bb_inst_17:                                       ; preds = %bb_inst_12
  ...
  store i64 2672, ptr %r1, align 4
  %42 = load i64, ptr %r1, align 4
  %43 = trunc i64 %42 to i16
  %44 = load ptr, ptr %r10, align 8
  %45 = getelementptr i8, ptr %44, i64 -8
  store i16 %43, ptr %45, align 2
  store i64 7882259360673000545, ptr %r1, align 4
  %46 = load i64, ptr %r1, align 4
  %47 = load ptr, ptr %r10, align 8
  %48 = getelementptr i8, ptr %47, i64 -16
  store i64 %46, ptr %48, align 4
  store i64 8533873931993441824, ptr %r1, align 4
  %49 = load i64, ptr %r1, align 4
  %50 = load ptr, ptr %r10, align 8
  %51 = getelementptr i8, ptr %50, i64 -24
  store i64 %49, ptr %51, align 4
  store i64 6004214541667288152, ptr %r1, align 4
  %52 = load i64, ptr %r1, align 4
  %53 = load ptr, ptr %r10, align 8
  %54 = getelementptr i8, ptr %53, i64 -32
  store i64 %52, ptr %54, align 4
  %55 = load i64, ptr %r10, align 4
  store i64 %55, ptr %r1, align 4
  %56 = load i64, ptr %r1, align 4
  %57 = add i64 %56, -32
  store i64 %57, ptr %r1, align 4
  store i64 27, ptr %r2, align 4
  %58 = load i64, ptr %r1, align 4
  %59 = load i64, ptr %r2, align 4
  %60 = load i64, ptr %r3, align 4
  %61 = load i64, ptr %r4, align 4
  %62 = load i64, ptr %r5, align 4
  %63 = call i64 @_bpf_helper_ext_0006(i64 %58, i64 %59, i64 %60, i64 %61, i64 %62)
  store i64 %63, ptr %r0, align 4
  br label %bb_inst_34

bb_inst_34:                                       ; preds = %bb_inst_17
  br label %bb_inst_76

bb_inst_35:                                       ; preds = %bb_inst_12
  %64 = load i64, ptr %r6, align 4
  store i64 %64, ptr %r1, align 4
  %65 = load i64, ptr %r1, align 4
  %66 = add i64 %65, 14
  ...
  store i64 %70, ptr %r2, align 4
  %71 = load ptr, ptr %r6, align 8
  %72 = getelementptr i8, ptr %71, i64 0
  %73 = load i16, ptr %72, align 2
  %74 = zext i16 %73 to i64
  store i64 %74, ptr %r3, align 4
  %75 = load ptr, ptr %r6, align 8
  %76 = getelementptr i8, ptr %75, i64 6
  %77 = load i16, ptr %76, align 2
  %78 = zext i16 %77 to i64
  store i64 %78, ptr %r4, align 4
  %79 = load i64, ptr %r4, align 4
  %80 = trunc i64 %79 to i16
  %81 = load ptr, ptr %r6, align 8
  ...
  store i64 %106, ptr %r5, align 4
  %107 = load i64, ptr %r5, align 4
  %108 = trunc i64 %107 to i16
  %109 = load ptr, ptr %r6, align 8
  %110 = getelementptr i8, ptr %109, i64 10
  store i16 %108, ptr %110, align 2
  %111 = load i64, ptr %r3, align 4
  %112 = trunc i64 %111 to i16
  %113 = load ptr, ptr %r6, align 8
  %114 = getelementptr i8, ptr %113, i64 6
  store i16 %112, ptr %114, align 2
  %115 = load i64, ptr %r4, align 4
  %116 = trunc i64 %115 to i16
  %117 = load ptr, ptr %r6, align 8
  ...
  store i64 %122, ptr %r3, align 4
  %123 = load i64, ptr %r3, align 4
  %124 = trunc i64 %123 to i32
  %125 = load ptr, ptr %r1, align 8
  %126 = getelementptr i8, ptr %125, i64 12
  store i32 %124, ptr %126, align 4
  %127 = load i64, ptr %r2, align 4
  %128 = trunc i64 %127 to i32
  %129 = load ptr, ptr %r1, align 8
  %130 = getelementptr i8, ptr %129, i64 16
  store i32 %128, ptr %130, align 4
  %131 = load i64, ptr %r6, align 4
  %132 = add i64 %131, 34
  store i64 %132, ptr %r6, align 4
  store i64 0, ptr %r1, align 4
  %133 = load i64, ptr %r1, align 4
  %134 = trunc i64 %133 to i8
  %135 = load ptr, ptr %r6, align 8
  %136 = getelementptr i8, ptr %135, i64 0
  store i8 %134, ptr %136, align 1
  %137 = load i64, ptr %r1, align 4
  %138 = trunc i64 %137 to i16
  %139 = load ptr, ptr %r6, align 8
  %140 = getelementptr i8, ptr %139, i64 2
  store i16 %138, ptr %140, align 2
  store i64 0, ptr %r1, align 4
  store i64 0, ptr %r2, align 4
  %141 = load i64, ptr %r6, align 4
  store i64 %141, ptr %r3, align 4
  store i64 64, ptr %r4, align 4
  store i64 0, ptr %r5, align 4
  %142 = load i64, ptr %r1, align 4
  %143 = load i64, ptr %r2, align 4
  %144 = load i64, ptr %r3, align 4
  %145 = load i64, ptr %r4, align 4
  %146 = load i64, ptr %r5, align 4
  %147 = call i64 @_bpf_helper_ext_0028(i64 %142, i64 %143, i64 %144, i64 %145, i64 %146)
  store i64 %147, ptr %r0, align 4
  br label %bb_inst_63

bb_inst_63:                                       ; preds = %bb_inst_35
  store i64 4294901760, ptr %r1, align 4
  %148 = load i64, ptr %r0, align 4
  store i64 %148, ptr %r2, align 4
  %149 = load i64, ptr %r2, align 4
  %150 = load i64, ptr %r1, align 4
  %151 = and i64 %149, %150
  store i64 %151, ptr %r2, align 4
  %152 = load i64, ptr %r0, align 4
  %153 = and i64 %152, 65535
  store i64 %153, ptr %r0, align 4
  %154 = load i64, ptr %r2, align 4
  %155 = lshr i64 %154, 16
  store i64 %155, ptr %r2, align 4
  %156 = load i64, ptr %r0, align 4
  %157 = load i64, ptr %r2, align 4
  %158 = add i64 %156, %157
  store i64 %158, ptr %r0, align 4
  %159 = load i64, ptr %r0, align 4
  store i64 %159, ptr %r1, align 4
  %160 = load i64, ptr %r1, align 4
  %161 = lshr i64 %160, 16
  store i64 %161, ptr %r1, align 4
  %162 = load i64, ptr %r1, align 4
  %163 = load i64, ptr %r0, align 4
  %164 = add i64 %162, %163
  store i64 %164, ptr %r1, align 4
  %165 = load i64, ptr %r1, align 4
  %166 = xor i64 %165, -1
  store i64 %166, ptr %r1, align 4
  %167 = load i64, ptr %r1, align 4
  %168 = trunc i64 %167 to i16
  %169 = load ptr, ptr %r6, align 8
  %170 = getelementptr i8, ptr %169, i64 2
  store i16 %168, ptr %170, align 2
  store i64 3, ptr %r7, align 4
  br label %bb_inst_76

bb_inst_76:                                       ; preds = %bb_inst_63, %bb_inst_34, %bb_inst_8, %bb_inst_6, %bb_inst_0
  %171 = load i64, ptr %r7, align 4
  store i64 %171, ptr %r0, align 4
  %172 = load i64, ptr %callItemCnt, align 4
  %173 = icmp eq i64 %172, 0
  br i1 %173, label %exitBlock, label %localFuncReturnBlock

exitBlock:                                        ; preds = %bb_inst_76
  %174 = load i64, ptr %r0, align 4
  ret i64 %174

localFuncReturnBlock:                             ; preds = %bb_inst_76
  %175 = load i64, ptr %callItemCnt, align 4
  %176 = sub i64 %175, 1
  %177 = getelementptr ptr, ptr %callStack, i64 %176
  %178 = load ptr, ptr %177, align 8
  %179 = sub i64 %175, 2
  %180 = getelementptr i64, ptr %callStack, i64 %179
  %181 = load i64, ptr %180, align 4
  store i64 %181, ptr %r6, align 4
  %182 = sub i64 %175, 3
  %183 = getelementptr i64, ptr %callStack, i64 %182
  %184 = load i64, ptr %183, align 4
  store i64 %184, ptr %r7, align 4
  %185 = sub i64 %175, 4
  %186 = getelementptr i64, ptr %callStack, i64 %185
  %187 = load i64, ptr %186, align 4
  store i64 %187, ptr %r8, align 4
  %188 = sub i64 %175, 5
  %189 = getelementptr i64, ptr %callStack, i64 %188
  %190 = load i64, ptr %189, align 4
  store i64 %190, ptr %r9, align 4
  %191 = sub i64 %175, 5
  store i64 %191, ptr %callItemCnt, align 4
  %192 = load i64, ptr %r10, align 4
  %193 = add i64 %192, 64
  store i64 %193, ptr %r10, align 4
  indirectbr ptr %178, []
}
