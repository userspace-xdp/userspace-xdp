...
bb_inst_0:                                        ; preds = %setupBlock
  ...
  %24 = load i64, ptr %r2, align 4
  %25 = load i64, ptr %r3, align 4
  %26 = load i64, ptr %r4, align 4
  %27 = load i64, ptr %r5, align 4
  %28 = call i64 @_bpf_helper_ext_0001(i64 %23, i64 %24, i64 %25, i64 %26, i64 %27)
  store i64 %28, ptr %r0, align 4
  br label %bb_inst_12

bb_inst_12:                                       ; preds = %bb_inst_0
  %29 = load i64, ptr %r0, align 4
  %30 = icmp eq i64 %29, 0
  br i1 %30, label %bb_inst_16, label %bb_inst_13

bb_inst_13:                                       ; preds = %bb_inst_12
  %31 = load ptr, ptr %r0, align 8
...
bb_inst_16:                                       ; preds = %bb_inst_13, %bb_inst_12
  %41 = load i64, ptr %r10, align 4
  store i64 %41, ptr %r2, align 4
  %42 = load i64, ptr %r2, align 4
  %43 = add i64 %42, -4
  store i64 %43, ptr %r2, align 4
  %44 = load i64, ptr %r10, align 4
  store i64 %44, ptr %r3, align 4
  %45 = load i64, ptr %r3, align 4
  %46 = add i64 %45, -8
  store i64 %46, ptr %r3, align 4
  store i64 0, ptr %r1, align 4
  store i64 0, ptr %r4, align 4
  %47 = load i64, ptr %r1, align 4
  %48 = load i64, ptr %r2, align 4
  %49 = load i64, ptr %r3, align 4
  %50 = load i64, ptr %r4, align 4
  %51 = load i64, ptr %r5, align 4
  %52 = call i64 @_bpf_helper_ext_0002(i64 %47, i64 %48, i64 %49, i64 %50, i64 %51)
  store i64 %52, ptr %r0, align 4
  br label %bb_inst_24
