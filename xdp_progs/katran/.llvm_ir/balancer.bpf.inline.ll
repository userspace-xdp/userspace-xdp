...
@__reals_stats = internal unnamed_addr global [8192 x i64] zeroinitializer, align 16
@__stats = internal unnamed_addr global [2048 x i64] zeroinitializer, align 16
...
bb_inst_982:                                      ; preds = %bb_inst_979
  ...
  %arrayidx1 = getelementptr inbounds [4096 x i32], [4096 x i32]* @__lru_miss_stats, i64 0, i64 %615
  %732 = ptrtoint ptr %arrayidx1 to i64
...
bb_inst_1672:                                     ; preds = %bb_inst_1669
  ...
  %arrayidx2 = getelementptr inbounds [4096 x i32], [4096 x i32]* @__lru_miss_stats, i64 0, i64 %981
  %1213 = ptrtoint ptr %arrayidx2 to i64
...
define dso_local i64 @bpf_helper_ext_0028(i64 noundef %0, i64 noundef %1, i64 noundef %2, i64 noundef %3, i64 noundef %4) local_unnamed_addr #2 {
