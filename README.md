...
For tools to generate optimize AOT code, see [xdp_progs/optimization.md](xdp_progs/optimization.md). After optimize the AOT code, you can use `AOT_OBJECT_NAME=$(BASIC_XDP_AOT_RES_NAME)` to load the AOT results into the runtime, for example:
