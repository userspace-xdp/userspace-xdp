...
define dso_local i64 @xxhash64(i8* noundef readonly %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #0 {
  %4 = icmp ugt i64 %1, 31
...
9:                                                ; preds = %5, %9
  ...
  %24 = or i64 %23, %19
  %25 = getelementptr inbounds i8, i8* %15, i64 2
  ...
  %34 = or i64 %29, %33
  %35 = getelementptr inbounds i8, i8* %15, i64 4
  ...
  %56 = add i64 %55, %13
  %57 = tail call i64 @llvm.fshl.i64(i64 %56, i64 %56, i64 31) #2
  %58 = mul i64 %57, -7046029288634856825
  %59 = getelementptr inbounds i8, i8* %15, i64 8
  %60 = load i8, i8* %59, align 1, !tbaa !5
  %61 = zext i8 %60 to i64
  %62 = getelementptr inbounds i8, i8* %15, i64 9
  %63 = load i8, i8* %62, align 1, !tbaa !5
  %64 = zext i8 %63 to i64
  %65 = shl nuw nsw i64 %64, 8
  %66 = or i64 %65, %61
  %67 = getelementptr inbounds i8, i8* %15, i64 10
  %68 = load i8, i8* %67, align 1, !tbaa !5
  %69 = zext i8 %68 to i64
  %70 = shl nuw nsw i64 %69, 16
  %71 = or i64 %66, %70
  %72 = getelementptr inbounds i8, i8* %15, i64 11
  ...
  %81 = or i64 %76, %80
  %82 = getelementptr inbounds i8, i8* %15, i64 13
  %83 = load i8, i8* %82, align 1, !tbaa !5
  %84 = zext i8 %83 to i64
  %85 = shl nuw nsw i64 %84, 40
  %86 = or i64 %81, %85
  %87 = getelementptr inbounds i8, i8* %15, i64 14
  %88 = load i8, i8* %87, align 1, !tbaa !5
  %89 = zext i8 %88 to i64
  %90 = shl nuw nsw i64 %89, 48
  %91 = or i64 %86, %90
  %92 = getelementptr inbounds i8, i8* %15, i64 15
  ...
  %98 = add i64 %97, %12
  %99 = tail call i64 @llvm.fshl.i64(i64 %98, i64 %98, i64 31) #2
  %100 = mul i64 %99, -7046029288634856825
  %101 = getelementptr inbounds i8, i8* %15, i64 16
  %102 = load i8, i8* %101, align 1, !tbaa !5
  %103 = zext i8 %102 to i64
  %104 = getelementptr inbounds i8, i8* %15, i64 17
  %105 = load i8, i8* %104, align 1, !tbaa !5
  %106 = zext i8 %105 to i64
  %107 = shl nuw nsw i64 %106, 8
  %108 = or i64 %107, %103
  %109 = getelementptr inbounds i8, i8* %15, i64 18
  %110 = load i8, i8* %109, align 1, !tbaa !5
  %111 = zext i8 %110 to i64
  %112 = shl nuw nsw i64 %111, 16
  %113 = or i64 %108, %112
  %114 = getelementptr inbounds i8, i8* %15, i64 19
  %115 = load i8, i8* %114, align 1, !tbaa !5
  %116 = zext i8 %115 to i64
  %117 = shl nuw nsw i64 %116, 24
  %118 = or i64 %113, %117
  %119 = getelementptr inbounds i8, i8* %15, i64 20
  %120 = load i8, i8* %119, align 1, !tbaa !5
  %121 = zext i8 %120 to i64
  %122 = shl nuw nsw i64 %121, 32
  %123 = or i64 %118, %122
  %124 = getelementptr inbounds i8, i8* %15, i64 21
  %125 = load i8, i8* %124, align 1, !tbaa !5
  %126 = zext i8 %125 to i64
  %127 = shl nuw nsw i64 %126, 40
  %128 = or i64 %123, %127
  %129 = getelementptr inbounds i8, i8* %15, i64 22
  %130 = load i8, i8* %129, align 1, !tbaa !5
  %131 = zext i8 %130 to i64
  %132 = shl nuw nsw i64 %131, 48
  %133 = or i64 %128, %132
  %134 = getelementptr inbounds i8, i8* %15, i64 23
  ...
  %182 = add i64 %181, %10
  %183 = tail call i64 @llvm.fshl.i64(i64 %182, i64 %182, i64 31) #2
  %184 = mul i64 %183, -7046029288634856825
  %185 = icmp ugt i64 %17, 31
  br i1 %185, label %9, label %186

186:                                              ; preds = %9
  %187 = tail call i64 @llvm.fshl.i64(i64 %58, i64 %58, i64 1) #2
  %188 = tail call i64 @llvm.fshl.i64(i64 %100, i64 %100, i64 7) #2
  %189 = add i64 %188, %187
  %190 = tail call i64 @llvm.fshl.i64(i64 %142, i64 %142, i64 12) #2
  %191 = add i64 %189, %190
  %192 = tail call i64 @llvm.fshl.i64(i64 %184, i64 %184, i64 18) #2
  %193 = add i64 %191, %192
  %194 = mul i64 %57, -2381459717836149591
  %195 = tail call i64 @llvm.fshl.i64(i64 %194, i64 %194, i64 31) #2
  ...
  %201 = tail call i64 @llvm.fshl.i64(i64 %200, i64 %200, i64 31) #2
  ...
  %207 = tail call i64 @llvm.fshl.i64(i64 %206, i64 %206, i64 31) #2
  ...
  %213 = tail call i64 @llvm.fshl.i64(i64 %212, i64 %212, i64 31) #2
...
276:                                              ; preds = %309, %284, %231
  ...
  %280 = getelementptr inbounds i8, i8* %228, i64 %277
  %281 = add i64 %278, %229
  br label %226
...
284:                                              ; preds = %282
  %285 = load i8, i8* %228, align 1, !tbaa !5
  %286 = zext i8 %285 to i64
  %287 = getelementptr inbounds i8, i8* %228, i64 1
  %288 = load i8, i8* %287, align 1, !tbaa !5
  %289 = zext i8 %288 to i64
  %290 = shl nuw nsw i64 %289, 8
  %291 = or i64 %290, %286
  %292 = getelementptr inbounds i8, i8* %228, i64 2
  %293 = load i8, i8* %292, align 1, !tbaa !5
  %294 = zext i8 %293 to i64
  %295 = shl nuw nsw i64 %294, 16
  %296 = or i64 %291, %295
  %297 = getelementptr inbounds i8, i8* %228, i64 3
  ...
  %303 = xor i64 %302, %227
  %304 = tail call i64 @llvm.fshl.i64(i64 %303, i64 %303, i64 23) #2
...
309:                                              ; preds = %307
  %310 = load i8, i8* %228, align 1, !tbaa !5
  %311 = zext i8 %310 to i64
  %312 = mul i64 %311, 2870177450012600261
  %313 = xor i64 %312, %227
  %314 = tail call i64 @llvm.fshl.i64(i64 %313, i64 %313, i64 11) #2
