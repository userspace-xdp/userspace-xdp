...
define dso_local i32 @xxhash32(i8* nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = icmp ugt i32 %1, 15
...
9:                                                ; preds = %5, %9
  ...
  %36 = add i32 %35, %13
  %37 = tail call i32 @llvm.fshl.i32(i32 %36, i32 %36, i32 13) #2
  ...
  %58 = add i32 %57, %12
  %59 = tail call i32 @llvm.fshl.i32(i32 %58, i32 %58, i32 13) #2
  %60 = mul i32 %59, -1640531535
  %61 = getelementptr inbounds i8, i8* %15, i64 8
  %62 = load i8, i8* %61, align 1, !tbaa !5
  %63 = zext i8 %62 to i32
  %64 = getelementptr inbounds i8, i8* %15, i64 9
  %65 = load i8, i8* %64, align 1, !tbaa !5
  %66 = zext i8 %65 to i32
  %67 = shl nuw nsw i32 %66, 8
  %68 = or i32 %67, %63
  %69 = getelementptr inbounds i8, i8* %15, i64 10
  %70 = load i8, i8* %69, align 1, !tbaa !5
  %71 = zext i8 %70 to i32
  %72 = shl nuw nsw i32 %71, 16
  %73 = or i32 %68, %72
  %74 = getelementptr inbounds i8, i8* %15, i64 11
  ...
  %80 = add i32 %79, %11
  %81 = tail call i32 @llvm.fshl.i32(i32 %80, i32 %80, i32 13) #2
  %82 = mul i32 %81, -1640531535
  %83 = getelementptr inbounds i8, i8* %15, i64 12
  %84 = load i8, i8* %83, align 1, !tbaa !5
  %85 = zext i8 %84 to i32
  %86 = getelementptr inbounds i8, i8* %15, i64 13
  %87 = load i8, i8* %86, align 1, !tbaa !5
  %88 = zext i8 %87 to i32
  %89 = shl nuw nsw i32 %88, 8
  %90 = or i32 %89, %85
  %91 = getelementptr inbounds i8, i8* %15, i64 14
  %92 = load i8, i8* %91, align 1, !tbaa !5
  %93 = zext i8 %92 to i32
  %94 = shl nuw nsw i32 %93, 16
  %95 = or i32 %90, %94
  %96 = getelementptr inbounds i8, i8* %15, i64 15
  ...
  %102 = add i32 %101, %10
  %103 = tail call i32 @llvm.fshl.i32(i32 %102, i32 %102, i32 13) #2
  %104 = mul i32 %103, -1640531535
  %105 = icmp ugt i32 %17, 15
  br i1 %105, label %9, label %106

106:                                              ; preds = %9
  %107 = tail call i32 @llvm.fshl.i32(i32 %38, i32 %38, i32 1) #2
  %108 = tail call i32 @llvm.fshl.i32(i32 %60, i32 %60, i32 7) #2
  %109 = add i32 %108, %107
  %110 = tail call i32 @llvm.fshl.i32(i32 %82, i32 %82, i32 12) #2
  %111 = add i32 %109, %110
  %112 = tail call i32 @llvm.fshl.i32(i32 %104, i32 %104, i32 18) #2
  %113 = add i32 %111, %112
  br label %116
...
123:                                              ; preds = %150, %116
  ...
  %125 = phi i8* [ %121, %116 ], [ %154, %150 ]
  %126 = phi i32 [ %122, %116 ], [ %155, %150 ]
  %127 = icmp ugt i32 %126, 3
  br i1 %127, label %128, label %156

128:                                              ; preds = %123
  %129 = load i8, i8* %125, align 1, !tbaa !5
  ...
  %140 = or i32 %135, %139
  %141 = getelementptr inbounds i8, i8* %125, i64 3
  ...
  %147 = add i32 %146, %124
  %148 = tail call i32 @llvm.fshl.i32(i32 %147, i32 %147, i32 17) #2
...
150:                                              ; preds = %158, %128
  ...
  %154 = getelementptr inbounds i8, i8* %125, i64 %151
  %155 = add i32 %152, %126
  br label %123
...
158:                                              ; preds = %156
  %159 = load i8, i8* %125, align 1, !tbaa !5
  %160 = zext i8 %159 to i32
  %161 = mul i32 %160, 374761393
  %162 = add i32 %161, %124
  %163 = tail call i32 @llvm.fshl.i32(i32 %162, i32 %162, i32 11) #2
